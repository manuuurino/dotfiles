...
local function perform_action(o)
    ...
    elseif shownitems[current_item].cmdline then
        local launch_arg = menubar.launch_args[shownitems[current_item].name] or {}
        awful.spawn((launch_arg.preload or "") .. " " .. (launch_arg.launchcmd or shownitems[current_item].cmdline) .. " " .. (launch_arg.param or ""))
